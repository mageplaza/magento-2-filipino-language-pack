# How to contribute Filipino Language pack
...
- [github_contributions.csv](https://github.com/mageplaza/magento-2-filipino-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza and Magento community.

- We will merge `github_contributions.csv` with [fil_PH.csv](https://github.com/mageplaza/magento-2-filipino-language-pack/blob/master/fil_PH.csv). Your Magento 2 store will use this csv file.

So, you should contribute to [github_contributions.csv](https://github.com/mageplaza/magento-2-filipino-language-pack/blob/master/github_contributions.csv) file.
...
#### Suggestions
- You can copy any part of `fil_PH.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `fil_PH.csv`, we will not approve it in this case.
