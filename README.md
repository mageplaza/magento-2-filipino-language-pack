...
2. [Install Filipino Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Filipino language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Filipino language pack {#active}
